...
public class PessoaClienteDAO extends Repository {
	...
	/**Método para cadas um cliente
	 * 	 * @param p - Classe cliente
	...
	/*
	public static PessoaCliente atualizaCadastro() {
	 //TODO:
		//como que vai funcionar pra pessoa atualizar algo do cadastro dela?vai que ela só quer alterar o telefone 
	}
	...
	public static List<PessoaCliente> retornarPessoas(){
		...
		try {
			...
			while (rs.next()) {
				...
				lista.add(new PessoaCliente(nomeCompleto,ddd,telefone,email,senha,tipoGenero,nascimento,cpf));
			}
